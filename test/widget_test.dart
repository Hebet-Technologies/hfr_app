...
void main() {
  ...
  testWidgets('loan form dropdowns accept selections without assertion errors', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const ProviderScope(
        child: MaterialApp(home: LoanRequestFormScreen()),
      ),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('training screen lays out approver mode cards without flex errors', (
    WidgetTester tester,
  ) async {
