...
class StaffPortalAccess {
  ...
  factory StaffPortalAccess.fromUser(
    ...
    final requestedMode = preferredMode ?? StaffPortalMode.employee;
    final activeMode =
        requestedMode == StaffPortalMode.approver && hasApproverMode
  ...
  bool get isApproverMode => activeMode == StaffPortalMode.approver;
